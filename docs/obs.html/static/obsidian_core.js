...
var gzip_hash = '164470669031617248598506964016421885777'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/mhc1'  // this value is replaced by the actual url prefix when compiled
}
